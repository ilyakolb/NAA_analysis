...
warning('WHEN YOU RUN THIS NEXT IT MAY ERROR OUT BECAUSE YOU RENAMED GECI_NAA_code FOLDER!!')
...
plates = {fullfile(GECI_imaging_dir, '20200211_GCaMP96uf_raw/P13a-20200127_GCaMP96uf'),...
    fullfile(GECI_imaging_dir, '20200211_GCaMP96uf_raw/P14a-20200127_GCaMP96uf'),...
    fullfile(GECI_imaging_dir, '20200211_GCaMP96uf_raw/P15a-20200127_GCaMP96uf'),...
    fullfile(GECI_imaging_dir, '20200211_GCaMP96uf_raw/P16a-20200127_GCaMP96uf')};
...
plates_2 = {
    ...
    fullfile(GECI_imaging_dir, '20190910_GCaMP96uf_analyzed/P6a-2compi0190826_GCaMP96uf'),...
