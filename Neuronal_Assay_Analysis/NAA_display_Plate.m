...
if strcmp(type, 'GCaMP96') ||strcmpi(type, 'GCaMP96b') || strcmpi(type, 'RCaMP96')|| strcmpi(type, 'RCaMP96b')||strcmpi(type, 'FRET96') ||strcmpi(type, 'OGB1')|| strcmpi(type, 'RCaMP96c') %OGB added by Hod 20131125 %% FRET96 was added by Hod 01Apr2013
    row = {'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'};
...
for i=1:ntotalwell
    ...
    if ~isempty(file)
        ...
        master_result{i}=S;
        if strcmpi(type, 'GCaMP96') ||strcmpi(type, 'GCaMP96b') || strcmpi(type, 'RCaMP96')||strcmpi(type, 'RCaMP96b')||strcmpi(type, 'FRET96') ||strcmpi(type, 'OGB1')|| strcmpi(type, 'RCaMP96c') %OGB added by Hod 20131125 %% FRET96 was added by Hod 01Apr2013
    ...
    for i = 1:ntotalwell
        ...
        if isempty(mr)
            ...
            line([radius - offset, radius + offset], [radius + offset, radius - offset], ...
                'Color', [0.5 0 0], ...
                'LineWidth', 8);
        elseif strcmpi(type, 'GCaMP96') ||strcmpi(type, 'GCaMP96b') || strcmpi(type, 'RCaMP96') || strcmpi(type, 'RCaMP96b') || strcmpi(type, 'OGB1')|| strcmpi(type, 'RCaMP96c')
...
%     export_fig(pdf_name, '-nocrop', fig_h);
print('FillPageFigure','-dpdf','-fillpage')
    ...
    for k=1:length(nAP)
        ...
        export_fig(pdf_name, '-nocrop', '-append', fig_h);
        clf(fig_h);
    end
