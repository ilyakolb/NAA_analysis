...
if false
        ...
        if strcmpi(type, 'GCaMP96') ||strcmpi(type, 'GCaMP96b') || strcmpi(type, 'RCaMP96')|| strcmpi(type, 'FRET96') || strcmpi(type, 'RCaMP96b')|| strcmpi(type, 'OGB1')|| strcmpi(type, 'GCaMP96b-ERtag') % changed by Hod 29Mar2013 and 05June2013 and 20131125
            segment_file_ID = 4;
        ...
        try
            NAA_script_ver3(segment_file_ID, nominal_pulse, type, segmentation_threshold);
        catch ME
    ...
    for i=3:length(subfolders) 
        NAA_process_dir_ver3(fullfile(plate_folder_path, subfolders(i).name), type, segmentation_threshold);
    end
end
