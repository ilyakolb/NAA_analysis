function NAA_pile_df_f_ver2(type, sub_type)
...
if strcmpi(type, 'GCaMP96') ||strcmpi(type, 'GCaMP96b') || strcmpi(type, 'RCaMP96')||strcmpi(type, 'RCaMP96b')||...
        ...
        ||strcmpi(type, 'GCaMP96u')||strcmpi(type, 'GCaMP96uf')||strcmpi(type, 'RCaMP96u')||strcmpi(type, 'RCaMP96uf')
...
if strcmpi(type, 'GCaMP96') || strcmpi(type, 'GCaMP96b') ||strcmpi(type, 'RCaMP96')||strcmpi(type, 'OGB1')||...
        ...
        ||strcmpi(type, 'GCaMP96u')||strcmpi(type, 'GCaMP96uf')||strcmpi(type, 'RCaMP96u')||strcmpi(type, 'RCaMP96uf')%updated 20170719
...
for i=1:length(files);
    ...
    if nROI >= minROI
        ...
        if strcmpi(type, 'GCaMP96') ||strcmpi(type, 'GCaMP96b') || strcmpi(type, 'RCaMP96')|| strcmpi(type, 'OGB1')||strcmpi(type, 'GCaMP96z')||strcmpi(type, 'RCaMP96z')||strcmpi(type, 'GCaMP96bf')||strcmpi(type, 'GCaMP96u')||strcmpi(type, 'GCaMP96uf')||strcmpi(type, 'RCaMP96u')||strcmpi(type, 'RCaMP96uf')%updated 20170719
