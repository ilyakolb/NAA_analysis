...
xlstitle={'Plate','Well','construct','ROI#','mCherry','F0','Fmax','norm F0','drr(1AP)','drr(2AP)','drr(3AP)','drr(5AP)','drr(10AP)','drr(20AP)','drr(40AP)','drr(80AP)','drr(160AP)','drr(max)','ES50','DT1/2(10AP)','RT1/2(10AP)','tpeak(10AP)','DT1/2(160AP)','T1','T2'};
...
for i=1:length(files);
    load(files(i).name,'para_arrayRatio','summaryRatio','cell_list','temperature1','temperature2','fmax');    
...
xlswrite(['NAA_result_',plate,'.xls'],M1);
