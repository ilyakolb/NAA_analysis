% title={'Plate','Well','ROI#','F0','df_fpeak
% (1AP)','df_fpeak(2AP)','df_fpeak(3AP)','df_fpeak(5AP)','df_fpeak
% (10AP)','df_fpeak(20AP)','df_fpeak(40AP)','df_fpeak(80AP)','df_fpeak(160AP)','decay half (10AP)','decay half (160AP)'};
...
for i=1:length(files);
    load(files(i).name,'para_arrayCFP','summaryCFP','cell_list','temperature1','temperature2','fmax');    
    para_array=para_arrayCFP;
    summary=summaryCFP;
...
xlswrite(['NAA_result_',plate,'CFP.xls'],M1);
