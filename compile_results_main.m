...
compile_results(fullfile(GECI_imaging_dir, '20191005_GCaMP96uf_analyzed'),'GCaMP96uf','0')
compile_results(fullfile(GECI_imaging_dir, '20191022_GCaMP96uf_analyzed'),'GCaMP96uf','0')
